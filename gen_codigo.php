...
$_SESSION['captcha_code'] = md5( $key );

// grab the base image from our pre-generated captcha image background

$captchaImage = imagecreatefrompng( "Tmp/captcha.png" );
...
$imageInfo = getimagesize( "Tmp/captcha.png" );
...
imagettftext( $captchaImage, 40, 0, 20, 55, $textColor, "fonts/VeraBd.ttf", $key );
